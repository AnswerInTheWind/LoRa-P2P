...
{
    GpioInit( &SX1276.DIO0, RADIO_DIO_0, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0 );
    GpioInit( &SX1276.DIO1, RADIO_DIO_1, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0 );
//    GpioInit( &SX1276.DIO2, RADIO_DIO_2, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0 );
    GpioInit( &SX1276.DIO3, RADIO_DIO_3, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0 );
